...
class GraphController extends Controller
{
    ...
    public function publishToPage(Request $request){
       ...
       $page_id = "336109887182105";


       try {
           $post = $this->api->post('/' . $page_id . '/feed', array('message' => $request->message, 'link' => $request->link), $this->getPageAccessToken($page_id));
   ...
   public function publishImageToPage(Request $request){
       $absolute_image_path = '/Users/dmitrijponizov/code/acme/storage/app/images/test.jpg';
       $page_id = "336109887182105";
